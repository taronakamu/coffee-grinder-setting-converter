...
const messages: Record<Locale, Messages> = {
  ...
  medianMatch: '~ {um} µm ({grindCategory})',
  grindExtraCoarse: 'Extra Coarse',
  grindCoarse: 'Coarse',
  grindMediumCoarse: 'Medium Coarse',
  grindMedium: 'Medium',
  grindMediumFine: 'Medium Fine',
  grindFine: 'Fine',
  grindExtraFine: 'Extra Fine',
  ...
  medianMatch: '~ {um} µm（{grindCategory}）',
  grindExtraCoarse: '極粗挽き',
  grindCoarse: '粗挽き',
  grindMediumCoarse: '中粗挽き',
  grindMedium: '中挽き',
